...
class Detailed_receivings extends Report
{
	...
	public function getDataColumns()
	{
		return array(
			'summary' => array(
				...
				array('consignmenter_name' => $this->lang->line('reports_supplied_by')),
	...
	public function getDataByReceivingId($receiving_id)
	{
		$this->db->select('receiving_id,
			...
			MAX(consignmenter.consignmenter_name) AS consignmenter_name,
		...
		$this->db->join('consignmenters AS consignmenter', 'receivings_items_temp.consignmenter_id = consignmenter.person_id', 'left');
