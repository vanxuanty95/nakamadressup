...
class Summary_consignmenters extends Summary_report
{
	...
	protected function _select(array $inputs)
	{
		...
		$this->db->select('
				MAX(CONCAT(consignmenter_c.consignmenter_name, " (", consignmenter_p.name, ")")) AS consignmenter,
	...
	protected function _group_order()
	{
		...
		$this->db->order_by('MAX(CONCAT(consignmenter_c.consignmenter_name, " (", consignmenter_p.name, ")"))');
	}
}
?>
