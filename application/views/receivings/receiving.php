...
<div id="register_wrapper">
	...
	<div class="panel-body form-group">
		<ul>
			...
			<li class="pull-right">
				<button id='new_item_button' class='btn btn-info btn-sm pull-right modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-btn-new='<?php echo $this->lang->line('common_new') ?>' data-href='<?php echo site_url("items/view"); ?>' title='<?php echo $this->lang->line('sales_new_item'); ?>'>
	...
	<div class="panel-body">
		...
		?>
			...
			<div class="form-group" id="select_customer">
				...
				<button id='new_consignmenter_button' class='btn btn-info btn-sm modal-dlg' data-btn-submit='<?php echo $this->lang->line('common_submit') ?>' data-href='<?php echo site_url("consignmenters/view"); ?>' title='<?php echo $this->lang->line('receivings_new_consignmenter'); ?>'>
