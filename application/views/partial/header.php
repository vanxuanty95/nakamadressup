...
<head>
	...
	<?php else : ?>
		...
		<link rel="stylesheet" type="text/css" href="dist/opensourcepos.css?rel=397f582d3d"/>
		...
		<div class="topbar">
			<div class="container">
				...
				<div class="navbar-right" style="margin:0">
					<?php echo anchor('home/change_password/'.$user_info->person_id, $user_info->name, array('class' => 'modal-dlg', 'data-btn-submit' => $this->lang->line('common_submit'), 'title' => $this->lang->line('employees_change_password'))); ?>
