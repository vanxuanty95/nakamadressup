	...
	<div class="tab-pane fade in active" id="customer_basic_info">
		<fieldset>
			<div class="form-group form-group-sm" style="display: none;">
				...
				<div class='col-xs-1'>
					<?php echo form_checkbox('consent', '1', $person_info->consent == '' ? (bool) !$this->config->item('enforce_privacy') : (bool) $person_info->consent); ?>
				</div>
			</div>
			...
			<div class="form-group form-group-sm" style="display: none;">
				<?php echo form_label($this->lang->line('customers_consignmenter_name'), 'consignmenter_name', array('class' => 'control-label col-xs-3')); ?>
				<div class='col-xs-8'>
					<?php echo form_input(
						array(
			...
			<div class="form-group form-group-sm" style="display: none;">
				...
				<div class='col-xs-1'>
					<?php echo form_checkbox('taxable', '1', $person_info->taxable == '' ? TRUE : (bool) $person_info->taxable); ?>
				</div>
			</div>
		...
		<div class="tab-pane" id="customer_mailchimp_info">
			<fieldset>
				...
				<div class="form-group form-group-sm">
					...
					<div class='col-xs-1'>
						<?php echo form_checkbox('mailchimp_vip', '1', $mailchimp_info['vip'] == '' ? FALSE : (bool) $mailchimp_info['vip']); ?>
					</div>
				</div>
