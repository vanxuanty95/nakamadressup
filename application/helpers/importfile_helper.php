...
function generate_import_items_csv($stock_locations,$attributes)
{
	...
	$csv_headers .= 'Barcode,"Item Name",Category,"Consignmenter ID","Cost Price","Unit Price","Tax 1 Name","Tax 1 Percent","Tax 2 Name","Tax 2 Percent","Reorder Level",Description,"Allow Alt Description","Item has Serial Number",item_image,HSN';
